        ...
        return(
            ...
            <div className="mt-[100px] flex">
                ...
                <div className="lg:w-[250px] flex flex-col absolute">
                    <Link to="clarence"><button className="bg-white lg:bg-white p-[5px] w-[50px] flex justify-end items-center border-none mb-[10px] rounded-r-[50px] h-[50px] cursor-pointer"><img src={image} alt="" className='w-[40px] h-[40px] rounded-[50%] hover:w-[100px]' /></button></Link>
                    ...
                    <div className="w-full ml-20 p-1 -mt-15 flex">
                        ...
                        <Link to="manolong_Number">
                            <div className="bg-white w-60 h-60 p-5">
                                <img src={manolong} alt="" className='w-50 h-40 justify-self-center'/>
                                <h1 className='justify-self-center font-bold m-3'>Manolong Adrianne</h1>
                            </div>
                        </Link>
