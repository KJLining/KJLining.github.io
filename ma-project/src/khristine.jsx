        ...
        return(
            ...
            <div className="w-full flex absolute mt-[20px]">
                    ...
                    <div className="w-[350px] p-[10px] ml-[10px] bg-white h-[335px] flex flex-col justify-center items-center">
                        <img src={lining} alt="" className='h-[200px] w-[300px] flex justify-center items-center' />
                        <h1 className='self-center text-[20px] mt-[-1px]'>Khristine Lining</h1>
                    ...
                    <div className="flex mt-[15px]">
                        ...
                        <Link to="ramirez">
                            <div style={{ cursor: 'pointer' }} className="w-[240px] p-[10px] ml-[5px] h-[230px] bg-white">
                                ...
                                <h1 className='justify-self-center text-[20px] mt[-1px]'>Nathaneil Ramirez</h1>
                        ...
                        <div className="">
                           ...
                           <div className="flex">
                             ...
                             <div className="bg-white ml-[10px] p-[10px] w-[200px] h-[200px]">
                                ...
                                <h1 className='justify-self-center text-[15px] mt-[-1px]'>Manolong Adrianne</h1>
