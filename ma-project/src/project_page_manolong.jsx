          ...
          <div className="w-full h-50 p-5 bg-amber-700 flex">
                ...
                <div className="w-[50%] ">
                    <div className="flex h-[80%] items-center justify-self-center">
                        <Link to="projectDESALIT"><img src={desalit} alt="" className='w-10 h-10 rounded-full mr-3' /></Link>
                        <Link to="projectRAMIREZ"><img src={nathaniel} alt="" className='w-20 h-20 rounded-full mr-3 ' /></Link>
                        <Link><img src={manolong} alt="" className='w-30 h-30 rounded-full mr-3 ' /></Link>
                        <Link to="projectCLARENCE"><img src={hermoso} alt="" className='w-20 h-20 rounded-full mr-3 ' /></Link>
                        <Link to="projectLINING"><img src={lining} alt="" className='w-10 h-10 rounded-full ' /></Link>

                    </div>
                    <p className='justify-self-center font-bold text-white'>Adrianne Manolong</p>
                </div>
...
export default Project_of_manolong