                    ...
                    <div className="flex">
                        {/* CARD */}
                                    ...
                                    {/* NATHANIEL */}
                                        <Link to="ramirezLOCATION">
                                            ...
                                            <h1 className='justify-self-center text-[15px] mt-5'>Nathaniel</h1>
                                    ...
                                    <Link to="jeannLOCATION">
                                        <div className="bg-white ml-[10px] p-[10px] w-[200px] h-[178px]">
                                            ...
                                            <h1 className='justify-self-center text-[15px] mt-5'>Jeann Makabago</h1>
                        ...
                        <Link to="khristineLOCATION">
                            <div style={{ cursor: 'pointer' }} className="w-[240px] p-[10px] ml-[5px] h-[208px] bg-white">
                                ...
                                <h1 className='justify-self-center text-[20px] mt-2'>Khristine Lining</h1>
...
export default Manolonglocation