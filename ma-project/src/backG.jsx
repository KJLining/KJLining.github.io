        ...
        return(
            ...
            <div className="mt-[100px] flex">
                ...
                <div className="lg:w-[250px] flex flex-col">
                    ...
                    <Link to="manolong_Gmail"><button className='bg-white lg:bg-white p-[5px] justify-end align-center flex border-none mb-[10px] rounded-r-[50px] w-[50px] h-[5-px] hover:w-[100px] cursor-pointer'><img src={image} alt="" className='w-[40px] h-[40px] rounded-[50%]' /></button></Link>
            ...
            <div className="w-full flex absolute mt-[20px]">
                <Link to="/">
                    <div className="w-[350px] p-[10px] ml-[10px] bg-white h-[335px] flex flex-col justify-center items-center">
                        <img src={manolong} alt="" className='h-[200px] w-[300px] flex justify-center items-center' />
                        <h1 className='self-center text-[20px] mt-[-1px]'>Manolong, Adrianne</h1>
                    ...
                    <div className="flex mt-[15px]">
                        ...
                        <Link to="khristine">
                            <div style={{ cursor: 'pointer' }} className="w-[240px] p-[10px] ml-[5px] h-[230px] bg-white">
                                <img src={lining} alt="" className='h-[130px] w-[210px] flex justify-self-center'/>
                                <h1 className='justify-self-center text-[20px] mt[-1px]'>Khristine Lining</h1>
                           ...
                           <div className="flex">
                             ...
                             {/* NATHANIEL */}
                                <Link to="ramirez">
                                    ...
                                    <h1 className='justify-self-center text-[15px] mt-[-1px]'>Nathaniel</h1>
                            ...
                            <Link to="jeann">
                                <div className="bg-white ml-[10px] p-[10px] w-[200px] h-[200px]">
                                    ...
                                    <h1 className='justify-self-center text-[15px] mt-[-1px]'>Jeann Desalit</h1>
