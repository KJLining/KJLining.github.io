...
import vid from './assets/HERMOSO_WEB.mp4'
    ...
    return(
        <>
         <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css" integrity="sha512-Evv84Mr4kqVGRNSgIGL/F/aIDqQb7xQ2vcrdIwxfjThSH8CSR7PBEakCr51Ck+w+/U6swU2Im1vVX0SVk9ABhg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
                 ...
                 <header>
                                <nav className=' w-full flex items-center justify-between bg-white text-[20px] h-13.5 p-[15px] md:text-black'>
        ...
        <div className="grid grid-cols-1 text-white">
            <div className="grid grid-cols-2 border-b-1">
                <div className="">
                    <div className="grid grid-cols-5 justify-self-center gap-2 items-center py-3">
                        <img src={nathaniel} alt="" className='w-15 h-15 rounded-full'/>
                        <img src={manolong} alt="" className='w-20 h-20 rounded-full '/>
                        <img src={hermoso} alt="" className='w-25 h-25 rounded-full'/>
                        <img src={lining} alt="" className='w-20 h-20 rounded-full'/>
                        <img src={desalit} alt="" className='w-15 h-15 rounded-full'/>
                    </div>
                    <p className='text-4xl justify-self-center mb-2'>Clarence Hermoso</p>
                </div>
                <div className="">
                    <p className='p-10'>“Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ullam aut sed velit animi nesciunt? Saepe asperiores quas sunt dolorem blanditiis doloremque, necessitatibus hic veritatis culpa consequuntur commodi distinctio, tenetur eos!”</p>
                </div>
            </div>
            <h1 className='text-2xl lg:text-5xl font-bold text-white justify-self-center mt-2'>Recent Project</h1>

            <div className="grid grid-cols-1 lg:grid-cols-2 mt-10">
                <video src="" controls className='w-150 justify-self-center'></video>
                <p className='text-white text-2xl lg:text-3xl justify-self-center p-5'><span className='font-bold'>Description:</span> Cafe is one of my early website that i done before, that website is not responsive</p>
            </div>
        </div>
        </>
    );
