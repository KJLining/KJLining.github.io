...
function ClarenceGMAIL(){
    ...
    return(
        ...
        <div className="absolute w-full h-[93%] bg-[rgb(160,109,51)] bg-gradient-to-b from-[#a06d33] to-[#3a2812]">
            ...
            <div className="mr-[-200px] w-[35%] h-[80vh] left-[67%] top-full absolute -translate-full">
                
                <img src={images} alt="" className='w-[100%] h-[80vh]'/>
        ...
        return(
            ...
            <div className="mt-[100px] flex">
                ...
                <div className="lg:w-[250px] flex flex-col">
                    <Link to="clarence">
                    <button className="bg-white lg:bg-white p-[5px] w-[50px] flex justify-end items-center border-none mb-[10px] rounded-r-[50px] h-[50px] cursor-pointer"><img src={image} alt="" className='w-[40px] h-[40px] rounded-[50%] hover:w-[100px]' /></button>
                    </Link>
                ...
                <div className="p-[10px]">
                    ...
                    <p className="text-[70px] lg:text-[120px] font-bold text-stroke-3 text-transparent">Clarence Hermoso</p>
                    <p className="text-[70px] lg:text-[120px] font-bold text-stroke-3 text-transparent leading-1.5">Clarence Hermoso</p>
                </div>
            </div>
        );
    }
        ...
        return(
            ...
            <div className="w-full mt-[10px] p-[10px]">
                <div className="flex justify-self-center w-[55%] justify-between">
                    {/* NATHANEIL */}
                    <Link to="khristineGMAIL">
                    <div className="bg-white h-40 w-35 p-3 pt-3">
                        <img src={lining} alt="" className='w-full h-25'/>
                        <p className='justify-self-center mt-2'>Khristine</p>
                    </div>
                    </Link>
                   ...
                   <div className="bg-white h-40 w-35 p-3 pt-3">
                        <img src={nathaniel} alt="" className='w-full h-25'/>
            ...
            <div className="w-full mt-[-40px] p-[10px]">
                ...
                <div className="flex justify-self-center w-[77%] justify-between">
                    ...
                    <Link to="jeannGMAIL">
                        <div className="bg-white h-45 w-40 p-3 pt-3">
                            <img src={desalit} alt="" className='w-full h-30'/>
