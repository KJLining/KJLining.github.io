...
import image3 from './jeann_bg.png'
import React, { useState } from 'react';
import { Link } from 'react-router-dom/cjs/react-router-dom.min';
import Ramirez from './ramirez'
import Header from './Header'

function JeannNumber(){
    ...
    return(
        ...
        <div className="absolute w-full h-[93%] bg-[rgb(160,109,51)] bg-gradient-to-b from-[#a06d33] to-[#3a2812]">
            ...
            <div className="mr-[-200px] w-[45%] h-[110vh] left-[35%] top-full absolute -translate-full">
                
                <img src={image3} alt="" className='w-[100%] h-[110vh]'/>
        ...
        return(
            ...
            <div className="mt-[100px] flex">
                ...
                <div className="lg:w-[250px] flex flex-col absolute">
                    <Link to="jeann"><button className="bg-white lg:bg-white p-[5px] w-[50px] flex justify-end items-center border-none mb-[10px] rounded-r-[50px] h-[50px] cursor-pointer"><img src={image} alt="" className='w-[40px] h-[40px] rounded-[50%] hover:w-[100px]' /></button></Link>
                    <Link to="jeannGmail">
                    ...
                    <div className="w-full ml-20 p-1 -mt-15 flex">
                        ...
                        <Link to="clarenceNUMBER">
                            <div className="bg-white w-60 h-60 p-5">
                                <img src={hermoso} alt="" className='w-50 h-40 justify-self-center'/>
