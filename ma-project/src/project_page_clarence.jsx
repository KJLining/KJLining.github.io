...
function Project_of_clarence(){
    ...
    return(
        ...
        {/* MAIN CONTENT */}
        <div id='Maincontents' className="absolute w-full h-[93%] bg-[rgb(160,109,51)] bg-gradient-to-b from-[#a06d33] to-[#3a2812]">
           
          <div className="w-full h-100 lg:h-50 p-5 bg-amber-700 lg:flex">
                {/* PICTURES */}
                <div className="w-full lg:w-[50%] ">
                    <div className="flex h-[80%] items-center justify-self-center">
                        <Link to="projectRAMIREZ"><img src={nathaniel} alt="" className='w-10 h-10 rounded-full mr-3' /></Link>
                        <Link to="projectMANOLONG"><img src={manolong} alt="" className='w-20 h-20 rounded-full mr-3 ' /></Link>
                        <Link><img src={hermoso} alt="" className='w-30 h-30 rounded-full mr-3 ' /></Link>
                        <Link to="projectLINING"><img src={lining} alt="" className='w-20 h-20 rounded-full mr-3 ' /></Link>
                        <Link to="projectDESALIT"><img src={desalit} alt="" className='w-10 h-10 rounded-full ' /></Link>

                    </div>
                    <p className='justify-self-center font-bold text-white'>Clarence Hermoso</p>
                </div>

            <div className="w-full h-50 lg:w-[50%] text-white lg:overflow-hidden">
          ...
          <h1 className='text-5xl font-bold text-white justify-self-center'>Recent Project</h1>
            ...
            <div className="w-full lg:flex items-center">
                <div className="w-full lg:w-[50%] h-100 p-5 items-center content-center">
                    <video src="" className='w-full h-80 justify-self-center ' controls></video>
                </div>
                <div className="w-full lg:w-[50%] h-100 p-5 text-white">Description: Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed libero accusantium enim magnam, temporibus quisquam ad possimus, rem unde similique dolorem. Blanditiis sed nobis dolorem at illo libero odio similique?
...
export default Project_of_clarence