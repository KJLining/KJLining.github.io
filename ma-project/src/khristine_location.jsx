import images from './lining_bg.png'
...
function Khristinelocation(){
    ...
    return(
        ...
        <div className="absolute w-full h-[93%] bg-[rgb(160,109,51)] bg-gradient-to-b from-[#a06d33] to-[#3a2812]">
            ...
            <div className="w-[50%] h-[80vh] left-full top-full absolute -translate-full">
        ...
        return(
            ...
            <div className="mt-[100px] flex">
                ...
                <div className="lg:w-[250px] flex flex-col">
                    ...
                    <Link to="khristineGmail"><button className='bg-white lg:bg-white p-[5px] justify-end align-center flex border-none mb-[10px] rounded-r-[50px] w-[50px] h-[5-px] hover:w-[100px] cursor-pointer'><img src={image} alt="" className='w-[40px] h-[40px] rounded-[50%]' /></button></Link>
                    ...
                    <div className="flex">
                        ...
                        <Link to="ramirezLOCATION">
                            <div style={{ cursor: 'pointer' }} className="w-[240px] p-[10px] ml-[5px] h-[208px] bg-white">
                                <img src={nathaniel} alt="" className='h-[130px] w-[210px] flex justify-self-center'/>
                                <h1 className='justify-self-center text-[20px] mt-2'>Nathaneil Ramirez</h1>
...
export default Khristinelocation