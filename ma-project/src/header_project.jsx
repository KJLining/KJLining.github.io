          ...
          <div className="w-full flex items-center justify-between text-red-500 text-[20px] h-13.5 p-[15px] md:text-white">
            ...
            <div className="">
                <ul className='hidden lg:flex items-center space-x-6 text-black'>
                    ...
                    <Link to="teams"><li className='p-1 hover:bg-[rgb(160,109,51)] hover:text-white rounded-xl'>MEMBER</li></Link>
                    <Link to="projectCLARENCE"><li className='p-1 bg-[rgb(160,109,51)] text-white rounded-xl'>PROJECTS</li></Link>
