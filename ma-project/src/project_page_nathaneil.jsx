        ...
        <div className="absolute w-full h-[93%] bg-[rgb(160,109,51)] bg-gradient-to-b from-[#a06d33] to-[#3a2812]">
          ...
          <div className="w-full h-50 p-5 bg-amber-700 flex">
                ...
                <div className="w-[50%] ">
                    <div className="flex h-[80%] items-center justify-self-center">
                        <Link to="projectLINING"><img src={lining} alt="" className='w-10 h-10 rounded-full mr-3' /></Link>
                        <Link to="projectDESALIT"><img src={desalit} alt="" className='w-20 h-20 rounded-full mr-3 ' /></Link>
                        <Link><img src={nathaniel} alt="" className='w-30 h-30 rounded-full mr-3 ' /></Link>
                        <Link to="projectMANOLONG"><img src={manolong} alt="" className='w-20 h-20 rounded-full mr-3 ' /></Link>
                        <Link to="projectCLARENCE"><img src={hermoso} alt="" className='w-10 h-10 rounded-full ' /></Link>

                    </div>
                    <p className='justify-self-center font-bold text-white'>Nathaneil Ramirez</p>
                </div>
          ...
          <h1 className='text-5xl font-bold text-white justify-self-center'>Recent Project</h1>
            ...
            <div className="justify-center  flex w-full">
                    ...
                    <button type="button" className='bg-amber-900 cursor-pointer mr-5 w-30 h-10 text-white font-bold'>Prev</button>
                    <button type="button" className='bg-amber-900 cursor-pointer w-30 h-10 text-white font-bold'>Prev</button>
...
export default Project_of_ramirez