...
import image3 from './ramirez_bg.png'
import React, { useState } from 'react';
import { Link } from 'react-router-dom/cjs/react-router-dom.min';
import Ramirez from './ramirez'

import Header from './Header'
function NathanielNumber(){
        ...
        return(
            ...
            <div className="mt-[100px] flex">
                ...
                <div className="lg:w-[250px] flex flex-col absolute">
                    <Link to="ramirez"><button className="bg-white lg:bg-white p-[5px] w-[50px] flex justify-end items-center border-none mb-[10px] rounded-r-[50px] h-[50px] cursor-pointer"><img src={image} alt="" className='w-[40px] h-[40px] rounded-[50%] hover:w-[100px]' /></button></Link>
                ...
                <div className="p-[10px] ml-63">
                    ...
                    <p className="text-[70px] lg:text-[120px] font-bold text-stroke-3 text-transparent">Nathaneil Ramirez</p>
                    <p className="text-[70px] lg:text-[120px] font-bold text-stroke-3 text-transparent leading-1.5">Nathaneil Ramirez</p>
                </div>
            </div>
        );
    }
                    ...
                    <div className="w-full ml-20 p-1 -mt-15 flex">
                        ...
                        <Link to="jeannNUMBER">
                            <div className="bg-white w-60 h-60 p-5">
                                <img src={desalit} alt="" className='w-50 h-40 justify-self-center'/>
                        ...
                        <Link to="manolong_NUMBER">
                            <div className="bg-white w-45 h-50 mt-10 ml-1 p-3">
                                <img src={manolong} alt="" className='w-50 h-30 justify-self-center'/>
                                <h1 className='justify-self-center font-bold mt-3'>Manolong Adrianne</h1>
                        ...
                        <Link to="khristineNUMBER">
                            <div className="bg-white w-45 h-50 mt-10 ml-1 p-3">
                                <img src={lining} alt="" className='w-50 h-30 justify-self-center'/>
...
export default NathanielNumber