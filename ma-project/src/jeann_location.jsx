        ...
        return(
            ...
            <div className="mt-[100px] flex">
                ...
                <div className="p-[10px]">
                    ...
                    <p className="text-[70px] lg:text-[120px] font-bold relative text-white leading-1.5 cursor-default">Jeann Location</p>
                    ...
                    <div className="flex">
                        ...
                        <Link to="clarenceLOCATION">
                            <div style={{ cursor: 'pointer' }} className="w-[240px] p-[10px] ml-[5px] h-[208px] bg-white">
                                ...
                                <h1 className='justify-self-center text-[20px] mt-2'>Clarence Hermoso</h1>
