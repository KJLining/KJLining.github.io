          ...
          <div className="w-full h-50 p-5 bg-amber-700 flex">
                ...
                <div className="w-[50%] ">
                    <div className="flex h-[80%] items-center justify-self-center">
                        ...
                        <Link><img src={lining} alt="" className='w-30 h-30 rounded-full mr-3 ' /></Link>
                        <Link to="projectDESALIT"><img src={desalit} alt="" className='w-20 h-20 rounded-full mr-3 ' /></Link>
                        <Link to="projectRAMIREZ"><img src={nathaniel} alt="" className='w-10 h-10 rounded-full ' /></Link>

                    </div>
                    <p className='justify-self-center font-bold text-white'>Khristine Lining</p>
                </div>
...
export default Project_of_lining